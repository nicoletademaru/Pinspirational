...
## bucketlist
pin1 = Pin.create(title: 'Classic white home decor', description: 'Inspiration for your next remodel', author_id: 2, pinboard_id: 3)
pin2 = Pin.create(title: 'Plant corner inspo', description: "Indoor picnic with plant ", author_id: 1, pinboard_id: 1)
pin3 = Pin.create(author_id: 2, pinboard_id: 2)
pin4 = Pin.create(title: "Paris in one day",  description: 'Interary for anyone planning a short trip to Paris', author_id: 1, pinboard_id: 4)
pin5 = Pin.create(title: 'Bathroom with fireplace', description: 'Perfect after a long day...', author_id: 2, pinboard_id: 3)
pin6 = Pin.create(title: "Waterfall Scene",  description: 'photographer: unknown', author_id: 1, pinboard_id: 4)
pin7 = Pin.create(title: 'A Single Plant', author_id: 1, pinboard_id: 1)
pin8 = Pin.create(title: 'Cute and Cuddly', author_id: 2, pinboard_id: 2)
pin9 = Pin.create(title: "Minimalistic Dining Room", author_id: 2, pinboard_id: 3)
pin10 = Pin.create(title: 'Best outdoor-sy, active breeds', description: "Learn about the best breeds to consider for your next adventure buddy",author_id: 2, pinboard_id: 2)
pin11 = Pin.create(title: "Northern Lights",  description: 'The best places and times to catch the aurora borealis', author_id: 1, pinboard_id: 4)
pin12 = Pin.create(title: "Indoor plant decorations", description: 'How to guide to incorporate plants into your home', author_id: 1, pinboard_id: 1)
pin13 = Pin.create(title: "Classy pop of color", description: "Subtle way to add a pop of color to your living room", author_id: 2, pinboard_id: 3)
pin14 = Pin.create(title: "San Francisco, CA",  description: 'Tourist-y things to avoid', author_id: 1, pinboard_id: 4)
pin15 = Pin.create(title: 'Goodest doggo', description: "Learn about the best breeds to consider for your next adventure buddy",author_id: 2, pinboard_id: 2)
pin16 = Pin.create(description: 'Unique and fun plant for your home', author_id: 1, pinboard_id: 1)
pin17 = Pin.create(description: "Beautiful dining area with fireplace", author_id: 2, pinboard_id: 3)
pin18 = Pin.create(title: "Top Hikes in Canada", author_id: 1, pinboard_id: 4)
pin19 = Pin.create(title: "Nursery corner", description: 'plants galore', author_id: 1, pinboard_id: 1)
pin20 = Pin.create(title: 'Why 2 dogs are better than 1', description: "Get a second best friend, you know you want to",author_id: 2, pinboard_id: 2)
pin21 = Pin.create(title: "Relaxing Destinations", description: "Your next vacation spot is here", author_id: 1, pinboard_id: 4)
pin22 = Pin.create(title: "Accents for a black Dresser", description: "Style ideas for the bedroom", author_id: 2, pinboard_id: 3)
pin23 = Pin.create(title: "How to keep your plants happy and healthy", description: 'plant health tips', author_id: 1, pinboard_id: 1)
pin24 = Pin.create(title: 'Besties', description: "Cute poodles",author_id: 2, pinboard_id: 2)
pin25 = Pin.create(title: "Cute bedroom themes", description: "Themes for everyone", author_id: 2, pinboard_id: 3)
pin26 = Pin.create(title: "Winter in Switzerland", description: "A winter wonderland", author_id: 1, pinboard_id: 4)
pin27 = Pin.create(title: 'Pomsky mix', description: "One of the best mixes",author_id: 2, pinboard_id: 2)
pin28 = Pin.create(title: "Plant friends", description: 'A plant for everybody', author_id: 1, pinboard_id: 1)
pin29 = Pin.create(title: "Simple Laundry Room Ideas", author_id: 2, pinboard_id: 3)
pin30 = Pin.create(title: 'Adorable puppies', description: "Puppy fever",author_id: 2, pinboard_id: 2)
pin31 = Pin.create(title: "Beautiful architecture around the world", description: "Architecture inspiration", author_id: 1, pinboard_id: 4)
pin32 = Pin.create(title: "Pink plant aesthetic", author_id: 1, pinboard_id: 1)
pin33 = Pin.create(title: "Lovely white bedroom", author_id: 2, pinboard_id: 3)
## home decor
## best friend
## green thumb
